...
function get_chat($token, $chat_id)
{
    ...
    return $make_request($token, $method_url, $payload);
}
...
function forward_message($token, $chat_id,
...
function copy_message($token, $chat_id, $message_id, $caption = null,
...
function send_dice($token, $chat_id, $emoji = null, $disable_notification = null, $reply_to_message_id = null, $reply_markup = null)
{
    $method_url = 'sendDice';
    $payload = ['chat_id' => $chat_id];
    if ($emoji) {
...
function send_photo($token, $chat_id, $photo, $caption = null, $reply_to_message_id = null, $reply_markup = null, $parse_mode = null, $disable_notification = null)
{
...
function send_media_group($token, $chat_id, $media, $disable_notification = null, $reply_to_message_id = null)
{
...
function send_location($token, $chat_id, $latitude, $longitude, $live_period = null, $reply_to_message_id = null, $reply_markup = null, $disable_notification = null)
{
...
function edit_message_live_location($token, $latitude, $longitude, $chat_id = null, $message_id = null, $inline_message_id = null, $reply_markup = null)
{
...
function stop_message_live_location($token, $chat_id = null, $message_id = null, $inline_message_id = null, $reply_markup = null)
{
...
function send_venue($token, $chat_id, $latitude, $longitude, $title, $address, $foursquare_id = null, $foursquare_type = null, $disable_notification = null, $reply_to_message_id = null, $reply_markup = null)
{
...
function send_contact($token, $chat_id, $phone_number, $first_name, $last_name = null, $vcard = null, $disable_notification = null, $reply_to_message_id = null, $reply_markup = null)
{
...
function send_video($token, $chat_id, $data, $duration = null, $caption = null, $reply_to_message_id = null, $reply_markup = null, $parse_mode = null, $supports_streaming = null, $disable_notification = null)
{
